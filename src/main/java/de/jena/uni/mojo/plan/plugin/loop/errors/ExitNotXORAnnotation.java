...
/**
 * Class ExitNotXORAnnotation.
 * A class representing a soundness violation that a loop exit is not an XOR.
 *
 * @author Dr. Dipl.-Inf. Thomas M. Prinz
 */
public class ExitNotXORAnnotation extends Annotation {

    /**
     * The failure description.
     */
    public static final String DESCRIPTION = "This loop has an exit that is not an exclusive gateway (XOR).";
     ...
     */
    public ExitNotXORAnnotation(Analysis analysis) {
     ...
     *            The analysis which defines this annotation.
     */
    protected ExitNotXORAnnotation(String description, Analysis analysis) {
