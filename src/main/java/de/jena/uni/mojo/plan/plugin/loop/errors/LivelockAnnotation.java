...
/**
 * Class LivelockAnnotation.
 * A class representing a structural violation that a loop does not have any exit.
 *
 * @author Dr. Dipl.-Inf. Thomas M. Prinz
 */
public class LivelockAnnotation extends Annotation {

    /**
     * The failure description.
     */
    public static final String DESCRIPTION = "This loop does not have any exit where the control can go away.";
     ...
     */
    public LivelockAnnotation(Analysis analysis) {
     ...
     *            The analysis which defines this annotation.
     */
    protected LivelockAnnotation(String description, Analysis analysis) {
