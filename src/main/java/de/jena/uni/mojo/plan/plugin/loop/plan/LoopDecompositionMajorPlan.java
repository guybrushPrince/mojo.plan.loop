...
/**
 * The Loop decomposition major plan performs a Loop decomposition.
 * 
 * @author Dipl.-Inf. Thomas M. Prinz
 * 
 */
@MajorAnalysisPlan(id = 4, name = "Loop Decomposition Major Plan", author = "Dr. Dipl.-Inf. Thomas M. Prinz", description = "The Loop decomposition major plan performs a Loop decomposition.")
public class LoopDecompositionMajorPlan extends MajorPlan {
	 ...
	 *            The element store.
	 */
	public LoopDecompositionMajorPlan(WorkflowGraph graph, WGNode[] map,
	...
	protected void execute() {
		...
		//
		// 3: Perform the loop decomposition
		//
		LoopDecomposition decomposition = new LoopDecomposition(graph, map, analysisInformation);
